...
public class Students {
	...
	public Students() {
		...
		System.out.println("Enter studens's first name");
		this.firstName = scan.nextLine();
		System.out.println("Enter studens's last name");
		this.lastName = scan.nextLine();
		System.out.println("Enter studens's class level");
	...
	public static void addStudentsToMap() {
		...
		while(!stop.equals("S")) {
			...
			System.out.println("Press Enter to go entrance");
			stop= scan.nextLine();
