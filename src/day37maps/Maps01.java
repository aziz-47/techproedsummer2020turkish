...
public class Maps01 {
	...
	public static void main(String[] args) {
		 ...
		 *             HahMapler  thread safe  degildir.
		 *             
		 */
		...
		System.out.println(hashMap);//{123456=Veli, 33333=Ali, 234=Mine}
		...
		hashMap.replace(2222, "Emin");//{33333=Ali, 2222=Emin} mineyi emein yapti
		System.out.println(hashMap);
